...
|Type|Name|Description|Schema|Default
|*Body*|*Json string for request body.* +
_required_|Input parameter list in json format. ex. {"action":"KILL_ALL_SESSIONS", "deviceReferences":[{"link":"https://localhost/mgmt/cm/system/machineid-resolver/<uuid>"}, {"link":"https://localhost/mgmt/cm/system/machineid-resolver/<uuid>&quot;}]}|<<_post_kill_access_all,post_kill_access_all>>|
|===
