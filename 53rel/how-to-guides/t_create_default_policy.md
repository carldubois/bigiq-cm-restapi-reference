...
### Overview
Describes how you use the REST API to create a Web Application Security policy.
...
Describes how you use the REST API to create a Web Application Security policy. 
The Web Application Security policy is a complex object with multiple sub collections, some of them have default values created by the system when the policy is created.

### REST API actions

1. Perform a POST operation to the policies collection. 

2. The data being sent to the server includes the name of the policy, the partition, the fullPath and the application language.
