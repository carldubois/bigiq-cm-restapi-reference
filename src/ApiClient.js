...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BigIqDeployConfiguration.ApiClient = factory(root.superagent);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost/mgmt/cm/firewall/tasks
     */
    this.basePath = 'https://localhost/mgmt/cm/firewall/tasks'.replace(/\/+$/, '');
