...
|*childTaskStates* +
_optional_|Description of child task state properties using by declare-mgmt-authority task object.|< <<_properties_declare-mgmt-authority_childtaskstates,childTaskStates>> > array
|*copyTaskReference* +
