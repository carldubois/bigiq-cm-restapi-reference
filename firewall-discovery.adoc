...
==== Description
Create a device discovery declare-mgmt-authority firewall task and add to collection.
...
|*200*|POST a device discovery firewall declare-mgmt-authority task.|<<_properties_declare_mgmt_authority_collection,properties_declare_mgmt_authority_collection>>
|*400*|Error response "Bad Request"|<<_error_collection,error_collection>>
|===


[[_declare-mgmt-authority_get]]
=== List of device declare-mgmt-authority firewall collection tasks managed by BIGIQ module (AFM).
....
...
==== Description
Returns the collection of device discover firewall declare-mgmt-authority tasks.
...
|===
|HTTP Code|Description|Schema
|*200*|Returns a collection of device discover firewall declare-mgmt-authority tasks.|<<_properties_declare_mgmt_authority_collection,properties_declare_mgmt_authority_collection>>
|*400*|Error response "Bad Request"|<<_error_collection,error_collection>>
|===


[[_declare-mgmt-authority_objectid_get]]
=== Used to get a single device discovery firewall declare-mgmt-authority task (AFM).
....
...
==== Description
Returns the device discovery firewall declare-mgmt-authority task identified by a endpoint URI (AFM).
...
|===
|HTTP Code|Description|Schema
|*200*|Device discovery firewall declare-mgmt-authority task object. (AFM)|<<_properties_declare-mgmt-authority,properties_declare-mgmt-authority>>
|*400*|Error response "Bad Request"|<<_error_collection,error_collection>>
|===
...
|*items* +
_optional_|Collection of device discovery firewall declare-mgmt-authority task objects.|< object > array
|*kind* +
_optional_ +
_read-only_|Type information for this device discovery firewall declare-mgmt-authority task collection object. cm:firewall:tasks:declare-mgmt-authority:dmataskcollectionstate|string
|*message* +
_optional_ +
