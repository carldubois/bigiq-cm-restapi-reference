...
==== Description
Returns all members (BIG-IP) devices that make up the purchased license pool identified by id/members for an endpoint URI.
...
|*freeDeviceLicenses* +
_optional_|Total number of free device licenses for this purchased license pool.|integer
|*generation* +
_optional_ +
