...
|*link* +
_optional_|Reference links to differencer task.|string
|===
...
|*link* +
_optional_|Reference links to discovery task.|string
|===
...
|Name|Description|Schema
|*isSubcollection* +
_optional_|Is subcollection of identity reference tasks.|boolean
|*link* +
_optional_|Reference links to discovery task.|string
|===
