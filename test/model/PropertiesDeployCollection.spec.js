...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigIqDeployConfiguration.PropertiesDeployCollection();
  });
  ...
  describe('PropertiesDeployCollection', function() {
    it('should create an instance of PropertiesDeployCollection', function() {
      // uncomment below and update the code to test PropertiesDeployCollection
      //var instane = new BigIqDeployConfiguration.PropertiesDeployCollection();
      //expect(instance).to.be.a(BigIqDeployConfiguration.PropertiesDeployCollection);
    });
