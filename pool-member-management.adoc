...
|*Path*|*objectId* +
_required_|Unique id assigned with a virutal pool.|string(UUID)|
|===
...
|Type|Name|Description|Schema|Default
|*Path*|*objectId* +
_required_|Unique id assigned to a virutal pool.|string(UUID)|
|===
...
|Type|Name|Description|Schema|Default
|*Path*|*objectId* +
_required_|Unique id assigned to a virutal pool member.|string(UUID)|
|===
...
|*kind* +
_optional_ +
_read-only_|Type information for this virutal pool collection object.|string
|*lastUpdateMicros* +
_optional_ +
